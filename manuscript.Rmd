...
institute:
  ...
  - ncstate: North Carolina State University, Department of Sociology and Anthropology, Raleigh, North Carolina, USA
...
output:
  ...
  bookdown::word_document2:
    reference_docx: format/reference_main.docx
    pandoc_args:
...
#### Figure 2. Comparing campaign costs and willingness to pay 
...
#### Figure 3. Estimates of coverage achieved by the 2018 and 2019 campaigns.
...
```{r fig4}
knitr::include_graphics("figs/fig4.jpeg")
```

#### figure 4. Dog demography and implications for campaign strategies
...
We want to particularly acknowledge the contributions to this work by Annie Yang, an undergraduate researcher and volunteer with Princeton University and the Mad Dog Initiative who tragically passed away in a car accident before this research was published.
