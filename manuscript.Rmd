...
*Willingness to pay*. *Person days*. *Vax per point*.
...
*Table 1 should describe dogs!! (Take out cat parts & keep dogs only, & person days, split by location!)* 
...
The 2018 campaign cost more overall and per animal vaccinated than the 2019 campaign, largely due to increased personnel costs (Fig 3A & B, Table 1). Reflecting the extra personnel necessary to run the central point campaign, the 2018 campaign also took substantially more person-days per animal vaccinated (Table 1). We found that in most contexts, charging owners for vaccination would result in minimal cost recovery (Fig 3C), but that even a nominal fee would significantly reduce vaccination coverage acheived (Fig 3D), particulary in the rural commune of Andasibe.
...
In Andasibe Ville, we were only able to did this in one of our campaign locations, due to the sparsely distributed households and roads throughout the area, as such coverage in this. Make sure to mention back calc of pop & hdr is it reasonable?
...
Targeting dogs only?
Point to lit on willingness to pay / person day comp / cost per animal vaccinated 

PrEP and exposures during vax, we had N exposures. Puppies were the easiest to handle for both owners and vaccinators and vax is effective in them. Better dosing guidelines. Longer lasting vax.
...
- Community based vax delivery particulalry in novel areas (could lower cost while improving coverage)
