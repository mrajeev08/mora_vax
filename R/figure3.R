...
layout_A <- fig3A + inset_element(map_inset, left = 0, right = 0.2,
...
fig3 <- (layout_A / fig3B) + plot_layout(heights = c(2, 1), guides = "collect")

ggsave("figs/fig3.jpeg", height = 6, width = 7)
