...
# Pull plot together ----------
fig4_top <- pyramid_A  + stable_age_B + plot_layout(nrow = 1, guides = "collect") 
fig4_bottom <- par_ests_C + vacc_plot_D + plot_layout(nrow = 1, guides = "collect")
fig4 <- fig4_top / fig4_bottom
ggsave("figs/fig4.jpeg", fig4, height = 7, width = 8)
