...
```{r}
# Age pyramid
animals_age <- read_csv(here("qs_for_jess/animals_age.csv"))
...
# with campaigns only
camp <- simvacc(tmax = 12*10, pup_surv = surv$psurv_pup, adult_surv = surv$psurv_adult, 
                revacc = 1, 
                pup_cov = 0, 
                campaign_cov = 0.7, campaign_times = seq(12, 12*10, by = 12), 
                pup_month_vacc = 1, 
...
# with pup vacc only
pup <- simvacc(tmax = 12*10, pup_surv = surv$psurv_pup, adult_surv = surv$psurv_adult, 
               revacc = 1, 
               pup_cov = 0.7, 
...
both <- simvacc(tmax = 12*10, pup_surv = surv$psurv_pup, adult_surv = surv$psurv_adult, 
                revacc = 1, 
                pup_cov = 0.7, 
                campaign_cov = 0.7, 
